export const rutas = [
    ...
    {path: '/discapacidad/:pag', meta: { Auth: false, title: 'Discapacidad' }, name: 'discapacidad', component: () => import(/* webpackChunkName: "Routes" */ './components/discapacidad/MainComponent.vue') },
]
